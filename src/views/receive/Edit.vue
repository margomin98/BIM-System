  ...
  <div class="main_section">
        ...
        <div class="col">
          <div class="input-group mb-3">
            ...
            <div class="search_section">
              <vue-multiselect v-model="details.PO_IDSelect" :options="DropdownArray.PO_ID" :allow-empty="false"
        ...
        <div class="col">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control text-center" placeholder="最多輸入20字"
              v-model="details.ShipmentCompany" />
          </div>
        </div>
        <div class="col">
          <div class="input-group  mb-3">
        ...
        <div class="col">
          <div class="input-group  mb-3">
            ...
            <div class="multi_user_select">
              ...
              <VueMultiselect v-model="details.InformedPersons" :options="DropdownArray.InformedPersons"
    ...
    <div class="info_wrap mt-5 col">
      ...
      <div class="content">
        ...
        <input type="file" id="fileInput2" ref="fileInput2" style="display: none" @change="handlePictureFile($event)"
          multiple />
        <swiper-container :autoHeight="true" class='swiper_section' :space-between="40" :pagination="pagination"
          ...
          <swiper-slide v-for="(file, index) in fileParams.viewPic" :key="index" class="custom-slide">
            ...
            <span class="remove_img" @click="deleteFile('picture', index, file)">x</span>
          </swiper-slide>
        </swiper-container>
...
async function getDetails() {
  checkRole(checkname.value)
    .then(result => {
      ...
      axios.get(`https://localhost:44302/GetDBdata/ReceivingGetData?ar_id=${AR_ID}`)
        .then((response) => {
...
function sendUpperForm() {
  return new Promise((resolve, reject) => {
    ...
    axios.post('https://localhost:44302/ReceivingMng/EditReceipt', form)
      .then(response => {
        const data = response.data;
        if (data.state === 'success') {
