    ...
    <div class="info_wrap col">
      ...
      <div class="content">
        ...
        <div class="col-12">
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class='red_star'>*</span> 維修廠商 :
            </div>
            <input ref="inputElement" type="text" class="form-control" placeholder="最多輸入20字"
              v-model="formParams.RepairCompany">
          </div>
        </div>
        <!-- 外部維修單號 -->
        <div class="col-12">
          <div class="input-group mb-3">
            <div class="input-group-prepend">
              <span class='red_star'>*</span> 外部維修單號 :
            </div>
            <input ref="inputElement" type="text" class="form-control" placeholder="最多輸入50字"
              v-model="formParams.ExternalRepairId">
          </div>
        </div>
        <div class="row g-0">
          <!-- 廠商聯絡人 -->
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="input-group mb-3">
              ...
              <input ref="inputElement" type="text" class="form-control" placeholder="最多輸入10字"
                v-model="formParams.ContactPerson">
            </div>
          </div>
          <!-- 聯絡電話 -->
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
