<template>
  ...
  <div class="main_section">
    ...
    <ag-grid-vue style="height: 380px" class="mb-5 ag-theme-alpine" :rowHeight="rowHeight" :columnDefs="columnDefs" :rowData="rowData" :paginationPageSize="pageSize" :pagination="true">
    </ag-grid-vue>
  </div>
</template>
