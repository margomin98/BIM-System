<template>
  ...
  <div class="main_section">
    ...
    <div class="container-fluid datagrid_section">
      <div class="row">
        ...
        <div class="col-xl-2 col-lg-2 col-md-6 col-12">
          <p>櫃位</p>
          <div class="dropdown">
            <button class="btn dropdown-toggle" type="button" id="cabinetDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" :disabled="AreaName === ''">
                {{ LayerName || LayerInit }}
              </button>
        ...
        <div class="col-xl-2 col-lg-2 col-md-6 col-12">
          ...
          <div class="date-selector">
            <div class="input-container">
              <input type="date" v-model="StartDate" class="date-input" @focus="showDatePicker = true" @blur="showDatePicker = false" :disabled="DateCategory === ''" />
            </div>
          </div>
        </div>
        <div class="col-xl-2 col-lg-2 col-md-6 col-12 flex-col">
          ...
          <div class="date-selector">
            <div class="input-container">
              <input type="date" v-model="EndDate" class="date-input" @focus="showEndDatePicker = true" @blur="showEndDatePicker = false" :disabled="DateCategory === ''" />
            </div>
          </div>
        </div>
      </div>
    ...
    <ag-grid-vue style="height: 380px" class="ag-theme-alpine" :rowHeight="rowHeight" :columnDefs="columnDefs" :rowData="rowData" :paginationPageSize="pageSize" :pagination="true">
    </ag-grid-vue>
  </div>
</template>
