  ...
  <div class="main_section">
    ...
    <div class="info_wrap col">
      ...
      <div class="tab_section mt-5">
          ...
          <div v-for="(item, index) in formData" :key="index" :class="['tab-pane', 'fade', { 'show active': index === 0 }]" :id="'tab' + (index + 1)" role="tabpanel" aria-labelledby="tab1-tab">
            ...
            <div class="col">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" v-model="item.AssetsId" />
              </div>
            </div>
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            ...
            <div class="col">
              ...
              <div class="input-group mb-3">
                ...
                <div class='selected_file'>
                  ...
                  <p class='file_upload_wrap' v-for="(file, img_index) in item.File" :key="img_index" style="cursor: pointer;">
                    <p @click="showImage(index, img_index)" data-bs-toggle="modal" data-bs-target="#img_modal">{{ file.name }}
                    </p>
                    <img class='delete_icon' src="@/assets/trash.png" @click="deleteFile(index, img_index)" style="margin-left: 10px;">
                  </p>
                </div>
              </div>
            </div>
        ...
        <!-- 列出已選擇檔案 -->
        <div class="modal fade" id="img_modal" tabindex="-1" role="dialog" aria-labelledby="imageModalLabel" aria-hidden="true">
