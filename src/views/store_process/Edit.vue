          ...
          <div v-for="(tab, index) in tabData" :key="index"
                ...
                <div class="input-group mb-3 check_box_wrap">
                  ...
                  <div class="d-flex align-items-center radio_wrap">
                    <input type="radio" class='form-check-input check_box' id="radio1"
                      ...
                      v-model="tab.itemAssetType" @change="resetUnitCount(index)" />
            ...
            <div class="col form_search_wrap">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" aria-label="Default"
                  aria-describedby="inputGroup-sizing-default" v-model="tab.itemProjectCode">
            ...
            <div class="col">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control readonly_box" aria-label="Default" v-model="tab.itemProjectName"
                  readonly />
              </div>
            </div>
            <!-- 頁籤 設備總類 & 設備分類-->
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="typeDropdown">
                      <p v-for="item in DropdownArray.EquipType" class="dropdown-item"
                        @click="selectType(item, index)">{{ item.Name }}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="input-group mb-3 justify-content-end">
                  ...
                  <div class="dropdown">
                    <button class="btn dropdown-toggle" type="button" id="categoryDropdown" data-bs-toggle="dropdown"
                      aria-haspopup="true" aria-expanded="false" :disabled="!tab.itemEquipTypeName">
                      {{ tab.itemEquipCategoryName || tab.EquipCategoryInit }}
                    </button>
                    <div class="dropdown-menu" aria-labelledby="categoryDropdown">
                      <p v-for="item in tab.EquipCategoryArray" class="dropdown-item"
                        @click="selectCategory(item, index)">{{ item.Name }}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="areaDropdown">
                      <p v-for="(item, area_index) in DropdownArray.Area" :key="area_index" class="dropdown-item"
                        @click="selectArea(index, item)">{{ item.Name }}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="input-group mb-3 justify-content-end">
                  ...
                  <div class="dropdown">
                    <button class="btn dropdown-toggle" type="button" id="cabinetDropdown" data-bs-toggle="dropdown"
                      aria-haspopup="true" aria-expanded="false" :disabled="!tab.itemAreaName">
                      {{ tab.itemLayerName || tab.LayerInit }}
                    </button>
                    <div class="dropdown-menu" aria-labelledby="cabinetDropdown">
                      <p v-for="(item, layer_index) in tab.LayerArray" :key="layer_index" class="dropdown-item"
                        @click="selectLayer(index, item)">{{ item.Name }}</p>
                    </div>
                  </div>
                  <button v-show="tab.itemLayerName" class="apply_btn" data-bs-toggle="modal"
            ...
            <div class="col">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" v-model="tab.itemAssetsId" placeholder="BFXXXXXXXX"
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                <div class="input-group mb-3">
                  ...
                  <input type="number" class="input-number readonly_box" aria-label="Default"
                    aria-describedby="inputGroup-sizing-default" readonly v-model="tab.itemPackageNum" />
                </div>
              </div>
              <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                <div class="input-group mb-3 justify-content-end">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="areaDropdown">
                      <p v-for="item in DropdownArray.PackageUnit" class="dropdown-item"
                        @click="selectPackageUnit(item, index)">{{ item }}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                <div class="input-group mb-3 justify-content-end">
                  ...
                  <div v-if="tab.itemAssetType === '耗材'" class="dropdown">
                    <button class="btn dropdown-toggle" type="button" id="areaDropdown" data-bs-toggle="dropdown"
                      aria-haspopup="true" aria-expanded="false" :disabled="tab.itemAssetType !== '耗材'">
                      {{ tab.itemUnit || '請選擇' }}
                    </button>
                    <div class="dropdown-menu" aria-labelledby="areaDropdown">
                      <p v-for="item in DropdownArray.Unit" class="dropdown-item" @click="selectUnit(item, index)">{{
              item }}</p>
                    </div>
                  </div>
                  <input v-else class="input-number readonly_box" type="text" v-model="tab.itemPackageUnit" min="1"
                    readonly>
                </div>
              </div>
            </div>
