...
<warn/>
      ...
      <div class="second_content">
        <ag-grid-vue style="height: 380px" class="ag-theme-alpine list" :rowHeight="rowHeight" :columnDefs="columnDefs1"
          :rowData="rowData1" :paginationAutoPageSize="true">
        </ag-grid-vue>
      </div>
      <div class="fixed_info">
        <div>
      ...
      <div class="third_content">
        <ag-grid-vue style="height: 380px" class="ag-theme-alpine list" :rowHeight="rowHeight" :columnDefs="columnDefs2"
          :rowData="rowData2" :paginationAutoPageSize="true">
        </ag-grid-vue>
      </div>
      ...
      <div class='five_content'>
        ...
        <div class="row g-0">
          <div class="col d-flex wrap">
            ...
            <div class="input-group">
              <textarea placeholder="最多100字" class="form-control readonly_box" id="inputTextarea" readonly
                v-model="details.VerifyMemo"></textarea>
            </div>
          </div>
        </div>
      </div>
