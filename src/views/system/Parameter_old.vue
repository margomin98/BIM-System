        ...
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link" id="storage-tab" data-bs-toggle="tab" data-bs-target="#storage" type="button"
              role="tab" aria-controls="storage" aria-selected="false">儲位區域</button>
          </div>
        </nav>
          ...
          <div class="tab-pane fade show active" id="equipment" role="tabpanel" aria-labelledby="equipment-tab"
            ...
            <div class='row g-0'>
              <div class='col-xl-6 col-lg-6 col-md-6 col-12 grid'>
                <div style='width:100%'>
                  <ag-grid-vue style="width: 100%" class="ag-theme-alpine" :rowDragManaged="true" :animateRows="true"
                    :headerHeight="0" :columnDefs="columnDefs" :rowData="rowData1"
                    @rowDragEnd="onRowDragEnd('equip_type', $event)"
                    @cellValueChanged="onCellValueChanged('equip_type')" @grid-ready="dataApi1">
                  </ag-grid-vue>
                </div>
              </div>
              ...
              <div class='col-xl-6 col-lg-6 col-md-6 col-12 grid'>
                <div style='width:100%'>
                  <ag-grid-vue style="width: 100%; height: 450px" class="ag-theme-alpine" :rowDragManaged="true"
                    :animateRows="true" :headerHeight="0" :columnDefs="columnDefs" :rowData="rowData2"
                    @rowDragEnd="onRowDragEnd('area', $event)" @cellValueChanged="onCellValueChanged('area')"
                    @grid-ready="dataApi2">
                  </ag-grid-vue>
                </div>
              </div>
