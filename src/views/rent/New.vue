  ...
  <div class="main_section">
    ...
    <div class="info_wrap col">
      ...
      <form>
        ...
        <div class="row g-0">
          <div class="col d-flex wrap column_section" style='border:none'>
            ...
            <textarea class="form-control" id="inputTextarea" placeholder='請填寫說明，最多100字'
      ...
      <div class='third_content'>
        <ag-grid-vue style="width: 100%; height:380px; background-color: #402a2a;"  :rowHeight="rowHeight" id='grid_table' class="ag-theme-alpine"
