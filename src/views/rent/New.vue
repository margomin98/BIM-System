    ...
    <div class="info_wrap col">
      ...
      <form class="first_content">
        ...
        <div class="row g-0">
          <div class="col d-flex wrap column_section" style='border:none'>
            ...
            <textarea class="form-control" id="inputTextarea" placeholder='最多輸入100字'
              v-model="myForm.Description"></textarea>
          </div>
        </div>
      </form>
      <div class="fixed_info">
      ...
      <div class='second_content'>
        <div class='wrap d-flex first_row'>
          <div class='col-xl-3 col-lg-3 col-md-3 col-12' style='padding-left:0'>
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="typeDropdown">
                <p v-for="(item, index) in myForm.EquipTypeArray" :key="index" class="dropdown-item"
          ...
          <div class='col-xl-3 col-lg-3 col-md-3 col-12'>
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="categoryDropdown">
                <p v-for="(item, index) in myForm.EquipCategoryArray" :key="index" class="dropdown-item"
          ...
          <div class="col-xl-3 col-lg-3 col-md-3 col-12">
            <p class="search_label"><span>*</span>數量 <img class="info_icon" src="@/assets/info.png"
                data-bs-toggle="tooltip" data-bs-placement="top" title="資產數量 ex: 3包螺絲釘"></p>
            <div class="number-input-box">
        ...
        <div class="row g-0">
          <div class="col-12 d-flex wrap text_input">
            ...
            <textarea class="form-control" id="inputTextarea" placeholder='最多輸入100字'
              v-model="myForm.RequiredSpec"></textarea>
          </div>
        </div>
      ...
      <div class='third_content'>
        ...
        <DataTable :size="'small'" :value="rowData" resizableColumns columnResizeMode="expand" showGridlines scrollable
          scrollHeight="420px" paginator :rows="10"
  ...
  .main_section {
    .info_wrap {
      ...
      .second_content {
        ...
        .input-group, .form-control,#readonly_box{
          height: 100%;
        }
