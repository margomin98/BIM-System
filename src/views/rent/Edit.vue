    ...
    <div class="info_wrap col">
      ...
      <form>
        ...
        <div class="row g-0">
          <div class="col d-flex wrap column_section" style='border:none'>
            ...
            <textarea class="form-control" id="inputTextarea" rows="1" placeholder='最多輸入100字'
      ...
      <div class='second_content'>
        <div class='wrap d-flex first_row'>
          ...
          <div class="col-xl-3 col-lg-3 col-md-3 col-12">
            <p class="search_label"><span>*</span>數量<img class="info_icon" src="@/assets/info.png" data-bs-toggle="tooltip"
        ...
        <div class="row g-0">
          <div class="col-12 d-flex wrap text_input">
            ...
            <textarea class="form-control" id="inputTextarea" rows="3" placeholder='最多輸入100字'
