            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="activeDropdown">
                <template v-for="item in Order_StatusArray" :key="item" >
                  <p class="dropdown-item" @click="selectItem(item, searchParams, 'Status')">{{ item }}</p>
                </template>
              </div>
            </div>
          </div>
...
import { UpdatePageParameter, createDatagrid, selectItem } from '@/assets/js/common_fn';
import { Order_StatusArray } from '@/assets/js/dropdown'
