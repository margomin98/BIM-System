          ...
          <div class="col-xl-auto col-lg-auto col-md-auto col-12">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="activeDropdown">
                <p :key="index" class="dropdown-item" @click="selectActive(item)">{{ item }}</p>
              </div>
            </div>
          </div>
          <!-- 使用專案 -->
...
import { getMngDatagrid } from '@/assets/js/common_api';
  export default {
    ...
    setup() {
      ...
      const datagridfield = [
        { header: "單號", field: "Show_AR_ID", width: '150px' },
        { header: "狀態", field: "ShipmentNum", width: '130px' },
        { header: "訂單編號", field: "ShipmentCompany", width: '150px' },
        { header: "使用專案", field: "GoodsNum", width: '180px' },
        { header: "採購來源", field: "ReceivedDate", width: '150px' },
        { header: "採購件數", field: "Recipient", width: '130px' },
        { header: "下訂日期", field: "Recipient", width: '130px' },
        { header: "承辦人員", field: "Recipient", width: '130px' },
      ]
      const rowData = ref([]);
      onMounted(() => {
