<template>
  <warn_title v-show="PageType === 'delete'" />
  ...
  <div class="content">
    ...
    <!-- 交付 人員&日期 -->
    <div v-show="PageType !== 'confirm'" class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-12">
        <div class="input-group mb-3">
          <div class="input-group-prepend">
            交付人員 :
    ...
    <div v-show="PageType !== 'confirm'" class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-12">
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control readonly_box" readonly v-model="upperForm.AssetsInOperator">
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-12">
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control readonly_box" readonly v-model="upperForm.AssetsInDate">
        </div>
      </div>
    </div>
    <!-- 備註 -->
    <div class="col mb-3">
      <div class="input-group">
        ...
        <textarea style="height: 200px;" class="form-control readonly_box" v-model="upperForm.Memo" readonly></textarea>
      </div>
    </div>
  </div>
  <!-- 頁籤部分 -->
  <div v-show="tabData.length > 0" class="tab_section mt-5">
    ...
    <div class="tab-content" id="nav-tabContent">
      <div v-for="(tab, index) in tabData" :key="index" :class="['tab-pane', 'fade', { 'show active': index === 0 }]" :id="'tab' + (index + 1)" role="tabpanel">
        ...
        <!-- 頁籤儲位 區域&櫃位 -->
        <div v-show="PageType !== 'confirm'" class="row g-0 row_wrap">
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="input-group mb-3">
        ...
        <!-- 頁籤保固期限 -->
        <div v-show="PageType !== 'confirm'" class="row g-0">
          <div class="col-xl-6 col-lg-6 col-md-6 col-12">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                保固期限 :
        ...
        <div class="col selected_file">
          <div class="input-group">
            ...
            <div class='selected_file_wrap'>
              <div v-for="(file , file_index) in tab.existFile" :key="file.FileName" class="file_upload_wrap">
                <p>{{ file.FileName }}
...
const { DropdownArray , upperForm , tabData, PageType } = storeToRefs(storageStore) ;
