<template>
  <div class="info_wrap col">
    ...
    <div class="fixed_info_count">
      <div>
        <p>總出庫數量：{{ props.totalNeed }}個</p>
      </div>
      <div>
        <p>已備數量：{{ props.totalSelect }}個</p>
      </div>
    </div>
    <div v-show="PageType !== 'delete'" class="fourth_content">
      <div class="fixed_info">
        <div>
          <p>備料簽章</p>
        </div>
    ...
    <div v-show="PageType !== 'delete'" class="five_content">
      <div class="fixed_info">
        <div>
          <p>審核簽章</p>
        </div>
    ...
    <div v-show="PageType !== 'delete'" class="six_content">
      <div class="fixed_info">
        <div>
          <p>交付簽章</p>
        </div>
...
const props = defineProps(['totalNeed', 'totalSelect'])
onUnmounted(() => {
  rentStore.$dispose();
  apiStore.$dispose();
})
