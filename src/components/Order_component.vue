            ...
            <div class="content">
                ...
                <div class="col-12">
                    <div class="input-group mb-3">
                        ...
                        <input ref="inputElement" type="text" class="form-control readonly_box" readonly v-model="formParams.AssetsId">
                    </div>
                </div>
                <!-- 資產編號 -->
                <div class="col-12">
                    <div class="input-group mb-3">
                        ...
                        <input ref="inputElement" type="text" class="form-control" placeholder="最多50字" v-model="formParams.AssetsId">
                    </div>
                </div>
                <!-- 採購來源 -->
                <div class="col-12">
                    <div class="input-group mb-3">
                        ...
                        <input ref="inputElement" type="text" class="form-control" placeholder="最多50字" v-model="Assets.Name">
                    </div>
                </div>
                <!-- 使用專案 -->
                <div class="col-12">
                    <div class="input-group mb-3">
                        ...
                        <input ref="inputElement" type="text" class="form-control" placeholder="最多100字" v-model="Assets.Name">
                    </div>
                </div>
                <div class="row g-0">
                    <!-- 下訂日期 -->
