                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr v-for="item in Form.NotOrdered">
                                <td class="table_content edit_order_btn"><button
                                        class="edit_order_btn_grey">編輯訂單</button></td>
                                <td><span>無</span></td>
                                <td>
                            ...
                            <tr v-for="item in Form.Ordered">
                                <td class="table_content edit_order_btn"><button
                                        :class="{ 'edit_order_btn_grey': Form.Status !== '採購中' && Form.Status !== '沖銷中' }"
                                        @click="editOrder(item.PO_ID)"
                                        :disabled="Form.Status !== '採購中' && Form.Status !== '沖銷中'">編輯訂單</button></td>
                                ...
                                <td class="table_content">
                                    <div class="item_number_wrap">
                                        <div v-for="asset in item.AssetList" :key="asset.AssetsId" class="item_number">
                                            <span>{{ asset.AssetsId }}&nbsp;&nbsp;&nbsp;&nbsp;*{{ asset.Number }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="table_content">{{ item.ItemName }}</td>
