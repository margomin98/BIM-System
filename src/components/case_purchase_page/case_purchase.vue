    ...
    <div>
                ...
                <div class="col form_search_wrap">
                    <div class="input-group mb-3">
                        ...
                        <div class="option_section">
                            <multiselect v-model="Form.ProjectSelect" :allow-empty="false"
                                @select="purchaseStore.onProjectSelect" :options="DropdownArray.ProjectCode"
            ...
            <div class="content">
                ...
                <div class="col">
                    <div class="input-group mb-3">
                        ...
                        <textarea style="height: 150px;" class="form-control " placeholder="最多輸入100字"
                            v-model="itemParams.RequiredSpec" />
                    </div>
                </div>
            </div>
            <div class="add_btn">
        ...
        <div class="info_wrap">
            <div class="purchase_list" role="region" tabindex="0">
                ...
                <!-- 無表格內容 -->
                <div class="empty_table" v-if="Form.Requisitions.length === 0">
                    尚未新增待採購項目
                </div>
